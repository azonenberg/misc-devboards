...
#set_output_delay -clock [get_clocks pclk_raw] -min -add_delay 0.000 [get_ports {fmc_ad[*]}]
#set_output_delay -clock [get_clocks pclk_raw] -max -add_delay 2.000 [get_ports {fmc_ad[*]}]
